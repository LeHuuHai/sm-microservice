...
| [`auth`](file:///c:/Users/hailh22/WorkSpace/checkpoint1/server-management/microservices/pkg/auth) | Xác thực & Phân quyền gRPC | `AuthInterceptor` (Unary authorization), `StreamAPIKeyInterceptor` (Stream auth). Định nghĩa `Role` & `Scope`. |
