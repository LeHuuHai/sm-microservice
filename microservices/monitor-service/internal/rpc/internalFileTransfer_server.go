...
type TransferHandler struct {
	pb.UnimplementedInternalFileTransferServiceServer
}
...
func (h *TransferHandler) DownloadReport(req *pb.DownloadReportRequest, stream pb.InternalFileTransferService_DownloadReportServer) error {
	if req.Filename == "" {
