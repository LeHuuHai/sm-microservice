...
const file_monitor_proto_rawDesc = "" +
	...
	"\n" +
	"chunk_data\x18\x01 \x01(\fR\tchunkData2r\n" +
...
var file_monitor_proto_depIdxs = []int32{
	0, // 0: monitor.InternalFileTransferService.DownloadReport:input_type -> monitor.DownloadReportRequest
	1, // 1: monitor.InternalFileTransferService.DownloadReport:output_type -> monitor.DownloadReportResponse
